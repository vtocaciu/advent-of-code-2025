...
def solve(circuits):
    ...
    while i <= CICLES:
        ...
        print(i, circuit_a, circuit_b, dist)
        i = i + 1
    ...
    for connection in connections:
        print(connection)
    sorted_connections = sorted(connections, key=len, reverse=True)
    return len(sorted_connections[0])*len(sorted_connections[1])*len(sorted_connections[2])
